...
![missing](../assets/img/230126_2.png)

![missing](../assets/img/230126_3.png)
...
![missing](../assets/img/230126_4.png)

![missing](../assets/img/230126_5.png)

3. z-index의 음수(-) 값
    * 첫번째 사진의 경우 .box2가 .box1을 덮는 것을 볼 수 있다. 이 경우 두번째 사진처럼 .box1의 z-index를 조정하지 않고 .box2에 z-index를 음수로 줘서 조정할 수 있다.

![missing](../assets/img/230126_6.png)

![missing](../assets/img/230126_7.png)
