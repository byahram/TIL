...
---
<p align="center">
<img width="50%" src="../assets/img/css.png">
</p>
...
![missing](../assets/img/230118_4.png)
...
1. 내부 Float 요소를 부모 컨테이너 안으로 집어 넣고 싶을 때
    * <https://codepen.io/minki607/pen/BazpOKa?editors=1100>
    ...
    ![missing](../assets/img/230118_5.png) *부모 컨테이너가 BFC가 아닌 경우*

    ![missing](../assets/img/230118_6.png) *부모 컨테이너가 BFC가 아닌 경우*
    
2. 외부 Float 요소를 부모 컨테이너 안으로 집어 넣고 싶을 때
    * <https://codepen.io/tmoon79/pen/WNKZyma>

    ![missing](../assets/img/230118_7.png) *Inline에 있는 다른 객체가 BFC가 아닌 경우*

    ![missing](../assets/img/230118_8.png) *Inline에 있는 다른 객체가 BFC가 아닌 경우*

3. Margin 겹치는 현상을 막고 싶을 때

    ![missing](../assets/img/230118_9.png) *부모 컨테이너가 BFC가 아닌 경우 마진 겹침 현상이 발생한다.*

    ![missing](../assets/img/230118_10.png) *부모 컨테이너가 BFC가 아닌 경우 마진 겹침 현상이 발생한다.*
...
![missing](../assets/img/230118_11.png)
